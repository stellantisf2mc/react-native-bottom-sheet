...
const BottomSheetComponent = /*#__PURE__*/forwardRef(function BottomSheet(props, ref) {
  ...
  useAnimatedReaction(() => animatedContainerHeight.value, (result, previous) => {
     ...
     */
    if (animatedAnimationState.value === ANIMATION_STATE.RUNNING && animatedAnimationSource.value === ANIMATION_SOURCE.GESTURE && animatedNextPositionIndex.value === -1) {
      animateToPosition(animatedClosedPosition.value, ANIMATION_SOURCE.GESTURE);
    }
  });
